...
func StartUSSD(sessionId, serviceCode, phoneNumber, text string) string {
	...
	if text == "" {
		// This is the first request. Note how we start the response with CON
		return `CON Welcome to health360 USSD service, please select an option
		1. Book appointment
		...
		return `CON Consultant detail: Dr Junaid is an Oxford graduate in cardiology, he has been practicing for 15 years and has dozen record to his belt.
		1. ₦Book`
